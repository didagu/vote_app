        ...
        <main class="contentArea">
            <div class="contentAreaInner  clearfix">
				...
				<!--if pettition has been adopted in law...voting also stops-->
                    <h1><span class="version status solved">Delete</span> <?php echo "$title";?></h1>
				...
				<div class="col-md-6">
                 ...
                 <input type="hidden" id="uv" value="<?php echo $count; ?>">
					<br>
						<h5>If you agree with this petition, cast an upvote here <?php //echo $user_id;?></h5>
				...
				<div class="discussion-area">
                    ...
                    <form method="post" action="events/processcomment.php">
                        <div class="comment-content">
